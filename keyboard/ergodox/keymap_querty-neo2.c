...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
     * |  Help  | UNDO | AGIN | Prev | FN6Co| EXEC |Vol Up|           | ScLk | WBAK | WFWD | WSTP | WHOM | WREF |  WFAV  |
     * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
     * |  MENU  |      | PSTE | Play | FN5Pa| STOP |------|           |------|  F1  |  F2  |  F3  |  F4  |  F5  |   F6   |
     * |--------+------+------+------+------+------|Vol Dn|           | Paus |------+------+------+------+------+--------|
     * | LShift |      | COPY | Next | FN7Cu| FIND |      |           |      |  F7  |  F8  |  F9  | F10  | F11  |  F12   |
     * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
     *   | MAIL |      | CUT  | Sel  |      |                                       | CALC | MYCM |      |      |      |
     *   `----------------------------------'                                       `----------------------------------'
     *                                        ,-------------.       ,-------------.
     *                                        |      | -L1  |       | APP  |      |
     *                                 ,------|------|------|       |------+------+------.
    ...
    KEYMAP(  // layer 1 : function and media keys
        ...
        HELP,UNDO,AGIN,MPRV, FN6,EXEC,VOLU,
        MENU,  NO,PSTE,MPLY, FN5,STOP,
        LSFT,  NO,COPY,MNXT, FN7,FIND,VOLD,
        MAIL,  NO, CUT,MSEL,  NO,
                                        NO,TRNS,
                                           LALT,
                                   NO,  NO,LCTL,
